...
### RQ5: Strategic ML in Federated Learning
...
### RQ7: Epistemology and Expertise
...
### RQ5: Flux of Capital
Can we capture the 'flux' of money / liquidity in certain communities?
What makes a community 'self sufficient' both in terms of (# gas stations per capita, # banks or religious or community institutions, etc) and (independent sovereign communities)? How big of a community before people start ‘relying’ on others (or, in other words, require more complex financial systems)? Or needing a different currency system (e.g., does Gaza/ West Bank use NIS)? What does ‘community institutions’ mean and how is their use correlated with quality of life and GDP?

### RQ6: Trust in Instiutions in the 2020s
...
### RQ7: Successes and Failures of 'The Market'
...
### RQ9: Labor elasticity and epistemic resilience
...
### RQ10: Microeconomic network effects

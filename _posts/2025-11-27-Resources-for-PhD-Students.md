...
A list of Resources for PhD Students.
...
* [[Reading Group Organizer Guide](../advice_docs/Reading Group Organizers Guide robin bowers.pdf){:target="_blank"}]


## Presentations and Talks
* [[How to Speak (YouTube)](https://www.youtube.com/watch?v=Unzc731iCUY){:target="_blank"}]
* [[Giving a Talk](../advice_docs/Workshop_GivingATalk.pdf){:target="_blank"}]
...
* [[Recommendation Letter Etiquette](../advice_docs/RECOMMENDATIONLETTEREtiquette.pdf){:target="_blank"}] 
* [[Seattle Pacific](https://spu.edu/depts/eng/documents/RECOMMENDATIONLETTEREtiquette.pdf){:target="_blank"}] 
* [[St. Olaf College](https://wp.stolaf.edu/english/how-to-ask-a-professor-for-a-letter-of-recommendation/){:target="_blank"}]
* [[Her Campus](https://www.hercampus.com/school/fiu/recommendation-letters-how-ask/){:target="_blank"}]
* [[WikiHow](https://www.wikihow.com/Ask-Your-Professor-for-a-Letter-of-Recommendation-Via-Email){:target="_blank"}]
* [[The Balance](https://www.thebalancemoney.com/how-to-ask-a-professor-for-a-recommendation-2060798){:target="_blank"}]
...
* [[What I Wish I Had Known Early in Graduate School but Didn't (and how to prepare for a good job afterward)](../advice_docs/Advice for AI Ph.D. Students.pdf){:target="_blank"}]
...
## Writing tips
* [[An Economist’s Guide to Visualizing Data](../advice_docs/writing_1.pdf){:target="_blank"}]
* [[Economical Writing](../advice_docs/writing_2.pdf){:target="_blank"}]
* [[Writing Tips for Ph. D. Students](../advice_docs/writing_3.pdf){:target="_blank"}]
* [[An Algorithm for a Good Research Paper](../advice_docs/An Algorithm for a Good Research Paper.html){:target="_blank"}]
* [[Writing Papers with	Karon](../advice_docs/writing_4.pdf){:target="_blank"}]
* [[Sample Abstracts](../advice_docs/urs-sampleabstracts.pdf){:target="_blank"}]
* [[Sample Posters](../advice_docs/urs-sampleposters-1.pdf){:target="_blank"}]
* [[Writing a Math Phase Two Paper](../advice_docs/writing_5.pdf){:target="_blank"}]
* [[General Instructions for Final Draft of Short Paper](../advice_docs/writing_6.pdf){:target="_blank"}]
* [[David Poole How to write a research paper](../advice_docs/writing_7.pdf){:target="_blank"}]
* [[Guiding Principles for Creating Your Public Image](../advice_docs/writing_8.pdf){:target="_blank"}]
* [[Some Advice on Writing a Technical Report](https://userpages.cs.umbc.edu/sherman/Courses/documents/TR_how_to.html){:target="_blank"}]
* [[Three Sins of Authors in Computer Science and Math (Jonathan Shewchuk)](http://www.cs.cmu.edu/~jrs/sins.html){:target="_blank"}]
* [[Guide for Scholarly Writing (Shomir Wilson))](https://shomir.net/scholarly_writing.html){:target="_blank"}]



## Reading tips
* Bret Victor (how to be an active reader). [Exploreable Explanations](https://worrydream.com/ExplorableExplanations/){:target="_blank"}
* [[How to Read a Paper](../advice_docs/reading_1.pdf){:target="_blank"}]
...
## Grants, theses, and fellowships
* [[How to get that first grant: A young scientist's guide to (AI) funding in America](https://cs.rpi.edu/~hendler/funding-talk/index.htm){:target="_blank"}]
...
## Links to Math Reference Websites
* The Book of Statistics Proofs. [[Link](https://statproofbook.github.io/){:target="_blank"}]
...
## Questions to Ask
* [[70 Questions To Ask About Grad School](https://www.gradschools.com/get-informed/admissions/70-questions-ask-when-visiting-grad-school){:target="_blank"}]
* [[Some Important Things Most Students Never Ask About Graduate School ](../advice_docs/advice_paper_web.pdf){:target="_blank"}]
* [[Applying to Graduate School Tips, Timeline, and Tools of the Trade](../advice_docs/GradSchoolGuide.pdf){:target="_blank"}]
* [[Applying to Ph.D. Programs in Computer Science](../advice_docs/gradschooltalk.pdf){:target="_blank"}]
* [[Gradate Studies at UC](../advice_docs/whats-next.pdf){:target="_blank"}]
* [[Choosing a Dissertation Advisor](../advice_docs/choosing_advisor.html){:target="_blank"}]
* [[Choosing a Ph.D. program in Computer Science](../advice_docs/choosing_cs_phd.html){:target="_blank"}]
* [[How to Write a Letter of Interest for Grad School](https://www.wikihow.life/Write-a-Letter-of-Interest-for-Grad-School){:target="_blank"}]

## Networking with professors
* [[Networking with professors](https://www.huffpost.com/entry/how-to-email-professors-and-virtually-guarantee-the-response_b_9190904){:target="_blank"}]
* [[How to Email a Professor: Research or Grad School Opportunity](https://sites.psu.edu/gileswriter/2016/08/26/research-opportunity-please-how-to-email-a-professor/){:target="_blank"}]
* [[The Do's and Don'ts of Contacting Professors about Research](https://senr.osu.edu/undergraduate/undergraduate-research/dos-and-donts){:target="_blank"}]
* [[(Shomir Wilson) Guide for Interacting With Faculty](../advice_docs/Shomir Wilson - Guide for Interacting With Faculty.html){:target="_blank"}]
* [[(Shomir Wilson) Guide for Joining My Lab](../advice_docs/Shomir Wilson - Guide for Joining My Lab.html){:target="_blank"}]




## Asking for Letters of Recommendations
* [[Cornell](https://gradschool.cornell.edu/inclusion/recruitment/prospective-students/requesting-letters-of-recommendation/){:target="_blank"}]    
* [[Mark Brehob (UMich)](https://web.eecs.umich.edu/~brehob/lor.htm){:target="_blank"}]

...
# Repository for Economic Data
* MarketWatch economic reporting calendar [[Link](https://www.marketwatch.com/economy-politics/calendar){:target="_blank"}]
* MacroMicro.me charts (e.g. [[FINRA Margin Debt](https://en.macromicro.me/charts/415/us-margin-debt){:target="_blank"}])
* Our World in Data [[Link](https://ourworldindata.org/){:target="_blank"}]
* Core Econ Curriculum [[Link](https://www.core-econ.org/about/){:target="_blank"}]
* Bloomberg
* NBER
* BEA
* BLS
* TradingEconomics
* World Bank [Link](https://data.worldbank.org/){:target="_blank"}
* IMF [Link](https://www.imf.org/en/data){:target="_blank"} [World Economic Outlook Databases](https://www.imf.org/en/publications/sprolls/world-economic-outlook-databases){:target="_blank"}
* OECD [Link](https://data-explorer.oecd.org/){:target="_blank"}
* Census Bureau [Link](https://www.census.gov/economic-indicators/){:target="_blank"}
* Harvard Atlas Growth Lab [Link](https://atlas.hks.harvard.edu){:target="_blank"}
* UN [Link](https://data.un.org/){:target="_blank"}
* USDA [Link](https://www.ers.usda.gov/){:target="_blank"}
* Cal State Econ Data List: [Link](https://library.csueastbay.edu/c.php?g=371833&p=2515353){:target="_blank"}
* Columbia Data List: [Link](https://guides.library.columbia.edu/ECON/INTL/DATA){:target="_blank"}
* Collins Dwight Blog: [140 best websites for economics data](https://collinsdwight.medium.com/140-best-websites-for-economic-data-e128cdc1dfc4){:target="_blank"}
...
* PricedInGold
    * [Website](https://pricedingold.com/){:target="_blank"}
* Economics From the Top Down by Dr. Blair Fix
    * [Blog](https://economicsfromthetopdown.com/){:target="_blank"}
...
* Political Science
  ...
  * Graetz and Shpiro. The Wolf at the Door.
  * Rothstein. The Color of Law.
  * Zinn. Peoples' History of the US.
...
* Reference and Other Recommendations:
  * Graeber. Debt: The First 5000 years.
  * Piketty. Capital in the 21st Century.
  * Malkiel. A Random Walk Down Wall Street.
* Life Advice
  * Carnegie. How to Win Friends and Influence Poeple.
  * Peterson. 12 Rules for Life.
  * Pollard. The Introverts' Edge.
  * Covey. 7 Habbits of Highly Effective People.
...
* Business
  ...
  * Masters and Thiel. From Zero to One.
...
* [(P06) Loand Survival Rate](../personal_finance/P06_Loan_Survival_Rate.pdf){:target="_blank"}
* [(P07) T-Bill Ladder](../personal_finance/P07_T_bill_ladder.pdf){:target="_blank"}
* [(P08) The More You Don't Know](../personal_finance/P08 The More You Don't Know.pdf){:target="_blank"}
